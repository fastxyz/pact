...
1. `https://raw.githubusercontent.com/fastxyz/pact/v1.1.0/CONTRACT.md` — read §1, §3, §4, §5, §8 carefully
2. `https://raw.githubusercontent.com/fastxyz/pact/v1.1.0/roles/coder.md`
3. `https://raw.githubusercontent.com/fastxyz/pact/v1.1.0/commands/code.md`

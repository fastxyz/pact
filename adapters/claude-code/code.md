...
1. `https://raw.githubusercontent.com/fastxyz/pact/v1.1.0/CONTRACT.md` — fetch with `Bash` (`curl -sL <url>`); read §1, §3, §4, §5, §8 carefully
2. `https://raw.githubusercontent.com/fastxyz/pact/v1.1.0/roles/coder.md` — fetch similarly
3. `https://raw.githubusercontent.com/fastxyz/pact/v1.1.0/commands/code.md` — fetch similarly
